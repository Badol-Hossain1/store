...
export default function Main() {
    return (
        <div className='overflow-hidden relative  container  md:rounded-lg z-0'>
            <div className='md:flex items-center w-full '>
                <div className='relative after:w-[1200px] after:h-[1200px] after:absolute after:top-[50%] after:left-[20%] after:translate-x-[-50%] after:translate-y-[-50%]  after:bg-[#3C06CA] after:rounded-full after:-z-10 z-20 text-white md:px-[20px]'>
